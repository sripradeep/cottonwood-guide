...
/* ─── Asset URLs ─────────────────────────────────────────────────────────── */
const P = (typeof window !== "undefined" && window.location.hostname.endsWith(".github.io")) ? "/cottonwood-guide/" : "/";
// Casita photos (from Airbnb listing)
const EXTERIOR_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/3de9b7c0-c75d-4721-9063-b7e7a005ac31.jpeg";
const LIVING_ROOM_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/93488ef7-9baf-4a11-b60c-953d3c77fca2.jpeg";
const BEDROOM_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/3d69ba65-0c7b-45c0-b5ff-f6cc683a9324.jpeg";
const DINING_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/f98ade1b-8f08-4757-b31d-0e14118bd51a.jpeg";
const ENTRANCE_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/d243ff27-a77b-4e02-b2aa-38e983aceb89.jpeg";
const KITCHEN_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/93488ef7-9baf-4a11-b60c-953d3c77fca2.jpeg";
const BEDROOM2_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/3d69ba65-0c7b-45c0-b5ff-f6cc683a9324.jpeg";
const HOT_TUB_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/5ae2e394-0915-449e-a040-0b65d2e68663.jpeg";
const OUTDOOR_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/5ae2e394-0915-449e-a040-0b65d2e68663.jpeg";
const FIRE_PIT_IMG = "https://a0.muscache.com/im/pictures/hosting/Hosting-1627618297620116650/original/2a0edca6-6127-4b12-aa6a-57cee4d292a4.jpeg";
// Shared assets
...
export default function Casita() {
  ...
  useEffect(() => { document.title = "Mingus Foothills Casita — Cottonwood, AZ"; }, []);
  ...
  return (
    <div className="min-h-screen bg-cream font-body">
      ...
      {/* ── Property ── */}
      <Section id="property">
        <SectionHeading icon={HomeIcon} title="Your Home" subtitle="An intimate desert casita in the Mingus Foothills — hot tub, fire pit, mountain views, and thoughtful design for up to four guests." />

        {/* Photo gallery grid */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-10 rounded-2xl overflow-hidden">
          <div className="col-span-2 row-span-2">
            <img src={EXTERIOR_IMG} alt="Casita exterior" className="w-full h-full object-cover" style={{minHeight: '280px'}} />
          </div>
          <img src={LIVING_ROOM_IMG} alt="Living area" className="w-full h-36 object-cover" />
          <img src={BEDROOM_IMG} alt="King bedroom" className="w-full h-36 object-cover" />
          <img src={DINING_IMG} alt="Mountain views" className="w-full h-36 object-cover" />
          <img src={ENTRANCE_IMG} alt="Casita entrance" className="w-full h-36 object-cover" />
        </div>

        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            <h2 className="font-display text-3xl font-bold text-foreground mb-2">Hot Tub | Fire Pit | Mountain Views</h2>
            <p className="font-body text-sm text-terracotta font-bold uppercase tracking-widest mb-4">Casita · 609 W Fir Street</p>
            <p className="font-body text-muted-foreground leading-relaxed mb-6">
              A quiet casita designed for genuine rest. Natural light pours through linen drapes onto wide-plank floors, and the whole space carries a calm, uncluttered feel. The king bedroom has blackout curtains and a Smart TV; the queen room offers the same comfort at a slightly smaller scale. Hot tub seats 4, fire pit seats 4. Sedona is 20 minutes away, Jerome 15, and Old Town Cottonwood's wine scene is just 5 minutes down the road.
            </p>
            ...
            <div className="bg-terracotta/5 border border-terracotta/20 rounded-xl p-4 space-y-2">
              ...
              <p className="font-body text-sm text-foreground">
                <strong className="text-terracotta">Book Again:</strong>{" "}
                <a href="https://www.airbnb.com/rooms/1627618297620116650" target="_blank" rel="noopener noreferrer"
                  className="text-terracotta underline hover:opacity-80">
                  View on Airbnb <ExternalLink size={11} className="inline" />
                </a>
              </p>
            </div>
          </div>
          <div className="space-y-4">
            <h3 className="font-display text-xl font-semibold text-foreground">Inside the Casita</h3>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <img src={HOT_TUB_IMG} alt="Hot tub" className="w-full h-36 object-cover rounded-xl mb-1" />
                <p className="font-body text-xs text-muted-foreground text-center">Hot tub (seats 4)</p>
              </div>
              <div>
                <img src={BEDROOM2_IMG} alt="Queen bedroom" className="w-full h-36 object-cover rounded-xl mb-1" />
                <p className="font-body text-xs text-muted-foreground text-center">Queen bedroom</p>
              </div>
              <div>
                <img src={FIRE_PIT_IMG} alt="Fire pit" className="w-full h-36 object-cover rounded-xl mb-1" />
                <p className="font-body text-xs text-muted-foreground text-center">Fire pit (seats 4)</p>
              </div>
              <div>
                <img src={OUTDOOR_IMG} alt="Outdoor deck" className="w-full h-36 object-cover rounded-xl mb-1" />
                <p className="font-body text-xs text-muted-foreground text-center">Outdoor deck</p>
              </div>
            </div>
            <div className="bg-white rounded-xl border border-border p-4">
              ...
              <div className="grid grid-cols-2 gap-1">
                {["Hot tub (seats 4)","Fire pit (seats 4)","Mountain & desert views","King bedroom","Queen bedroom","Smart TVs + blackout curtains","Fully stocked kitchen","Free parking","Self check-in","High-speed WiFi","Drip coffee + espresso","At-home coffee setup"].map(a => (
      ...
      <Section id="daytrips" className="bg-cream">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <AttractionCard img={SEDONA_IMG} title="Sedona Red Rocks" distance="~20 min"
            ...
            tags={["Hiking", "Vortex Sites", "Galleries", "Stargazing"]} link="https://visitsedona.com" />
          <AttractionCard img={JEROME_IMG} title="Jerome Ghost Town" distance="~20 min"
            description="Perched on Cleopatra Hill at 5,000 ft, Jerome was Arizona's wildest copper mining town — largely abandoned when the mines closed, then reborn as a quirky arts community. Don't miss the Jerome Grand Hotel, the Haunted Hamburger, cobblestone shops, and the Hang Glider Launch overlook for sunset views."
            tags={["Ghost Town", "Art Galleries", "Ghost Tours", "Views"]} link="https://www.visitarizona.com/places/cities/jerome" />
          <AttractionCard img={RAILROAD_IMG} title="Verde Canyon Railroad" distance="~10 min"
            ...
            tags={["Scenic Train", "Wildlife", "Canyon Views"]} link="https://verdecanyonrr.com" />
          <AttractionCard img={TUZIGOOT_IMG} title="Tuzigoot National Monument" distance="~5 min"
            ...
            tags={["History", "Archaeology", "National Monument"]} link="https://www.nps.gov/tuzi/" />
          <AttractionCard img={VERDE_VINEYARD_IMG} title="Alcantara Vineyards" distance="~10 min"
            ...
            tags={["Winery", "Vineyard Views", "Wine Trail"]} link="https://alcantaravineyard.com" />
          <AttractionCard img={OLD_TOWN_IMG} title="Old Town Cottonwood" distance="Walking / 5 min"
            ...
            tags={["Wine Tasting", "Dining", "Shopping", "Walkable"]} link="https://www.oldtown.org" />
          <AttractionCard img={SEDONA_IMG} title="Chapel of the Holy Cross" distance="~25 min"
            ...
            tags={["Landmark", "Views", "Architecture", "Free Entry"]} link="https://www.chapeloftheholycross.com" />
          <AttractionCard img={JEROME_IMG} title="Tlaquepaque Arts Village" distance="~25 min"
            ...
            tags={["Art Galleries", "Shopping", "Restaurants", "Culture"]} link="https://www.tlaq.com" />
          <AttractionCard img={DEAD_HORSE_IMG} title="Blazin' M Ranch" distance="~5 min"
            ...
            tags={["Family Fun", "Western Entertainment", "Dinner Show"]} link="https://blazinm.com" />
        </div>
      </Section>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-12">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <img src={OUTDOOR_IMG} alt="Hot tub deck" className="rounded-xl w-full h-32 object-cover" />
              <img src={FIRE_PIT_IMG} alt="Fire pit" className="rounded-xl w-full h-32 object-cover" />
            </div>
          </div>
          <div>
      ...
      <Section id="antiques">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="order-1 md:order-2">
            <img src={OLD_TOWN_IMG} alt="Old Town Cottonwood" className="rounded-2xl shadow-lg w-full h-96 object-cover" />
      ...
      <footer className="bg-charcoal text-white py-12">
        <div className="container text-center">
          ...
          <p className="font-body text-xs text-white/30 mt-6">
            Guest Guidebook · Casita at 609 W Fir St, Cottonwood, AZ · Updated 2026
          </p>
        </div>
      </footer>
    </div>
